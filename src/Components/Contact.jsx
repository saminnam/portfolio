...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappNumber = "918608373370";
    const { name, email, phone, company, message } = formData;
    const encodedMessage = encodeURIComponent(
      `Hello! 👋 Innam message from portfolio\n\nName: ${name}\nEmail: ${email}\nPhone: ${phone}\nCompany: ${company}\nMessage: ${message}`
    );
                ...
                <form onSubmit={handleSubmit} className="mt-8">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                    ...
                    <div className="sm:col-span-2">
                      <button
                        type="submit"
                        className="inline-flex text-white items-center justify-center w-full px-4 py-4 mt-2 text-base font-semibold transition-all duration-200 bg-blue-600 border border-transparent rounded-md focus:outline-none hover:bg-blue-700 focus:bg-blue-700"
                      >
                        Send via WhatsApp
                      </button>
                    </div>
            ...
            <div className="bg-gray-100 lg:col-span-2">
              <div className="h-full p-6 sm:p-10">
                <div>
                  ...
                  <div className="mt-8 space-y-7 h-[400px]">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15554.196244981349!2d80.13965674526743!3d12.936678748005564!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a525e559242a1bd%3A0x6b70bdfe68e633c6!2sHasthinapuram%2C%20Chromepet%2C%20Chennai%2C%20Tamil%20Nadu!5e0!3m2!1sen!2sin!4v1744619765655!5m2!1sen!2sin"
                    ...
                    <ul className="flex items-center justify-end space-x-3">
                      ...
                      <li>
                        <a
                          ...
                          title="Github"
                          className="flex items-center justify-center text-gray-800 transition-all duration-200 bg-transparent border border-gray-300 rounded-full  w-7 h-7 focus:bg-blue-600 hover: focus: hover:bg-blue-600 hover:border-blue-600 focus:border-blue-600"
                        >
                          <svg
                            className="w-4 h-4"
                            xmlns="http://www.w3.org/2000/svg"
